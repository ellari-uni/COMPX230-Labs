...
synth_design -top die -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef die.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file die_utilization_synth.rpt -pb die_utilization_synth.pb"  } 
