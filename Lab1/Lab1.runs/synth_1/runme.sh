...
HD_PWD='/home/hg234/2025/COMPX230/Labs/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log die.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source die.tcl
